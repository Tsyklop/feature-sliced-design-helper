...
import design.featuresliced.helper.gui.dialog.creation.slice.old.NewEntityCreationDialog;
...
public class NewEntityCreationAction extends BaseSliceCreationAction {
    ...
    public NewEntityCreationAction(@Nullable String text, @Nullable String description, @Nullable Icon icon) {
        super(text, description, icon);
    }

    @Override
    protected @NotNull BaseSliceCreationDialog<?> createDialog(@NotNull Project project, JsLibraryType jsLibrary) {
        return new NewEntityCreationDialog(project, jsLibrary);
    }
