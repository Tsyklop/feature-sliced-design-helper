...
import design.featuresliced.helper.ui.form.NewWidgetForm;
...
public class NewWidgetDialog extends BaseDialogWrapper<NewWidgetForm> {

    public NewWidgetDialog(@NotNull Project project) {
        super("Create Widget", new NewWidgetForm(), project, FsdLayerType.WIDGETS);
    }
    ...
    protected void doOKAction() {
        ...
        Notify.show(this.project, "Widget created!", NotificationType.INFORMATION);
