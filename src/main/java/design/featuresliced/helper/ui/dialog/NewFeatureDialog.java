...
import design.featuresliced.helper.ui.form.NewFeatureForm;
...
public class NewFeatureDialog extends BaseDialogWrapper<NewFeatureForm> {

    public NewFeatureDialog(@NotNull Project project) {
        super("Create Feature", new NewFeatureForm(), project, FsdLayerType.FEATURES);
    }
    ...
    protected @Nullable ValidationInfo doValidate() {
        if (StringUtils.isEmpty(this.form.getNameTextField().getText())) {
            ...
            return new ValidationInfo("Please enter a entity name", this.form.getNameTextField());
        }
    ...
    protected void doOKAction() {
        ...
        Notify.show(this.project, "Feature created!", NotificationType.INFORMATION);
