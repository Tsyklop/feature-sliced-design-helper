...
public class StyleUtil {
    ...
    public static String createStyleDependsOnTypeAndReturnImportStatementPart(String componentName, VirtualFile componentDir, StyleType styleType) throws IOException {
